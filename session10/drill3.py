singer = {
    ...
    She gained a following in 2016 when she released her debut single "Ocean Eyes" on audio distribution platform SoundCloud. 
    The single would subsequently be re-released under the record labels Darkroom and Interscope Records.''',
    'Drake' : '''    Aubrey Drake Graham (born October 24, 1986) is a Canadian rapper, singer, songwriter, record producer, actor, and entrepreneur. 
    ...
    Intent on pursuing a career in music, he left the series in 2007 after releasing his debut mixtape, Room for Improvement. 
